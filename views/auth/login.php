    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="md:bg-gray-50 dark:md:bg-neutral-900 md:border md:border-gray-200 dark:md:border-neutral-800 md:rounded-xl md:shadow-sm md:p-8">
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h1 class="mt-8 text-center text-2xl/9 font-bold tracking-tight text-gray-900 dark:text-neutral-200">Inicia sesión con tu cuenta</h1>
                <p class="text-center text-gray-600 font-normal dark:text-neutral-400">Accede a tu cuenta de forma <span class="text-blue-600 font-semibold">segura</span> y mantén tus finanzas bajo control.</p>
            </div>
            <!-- Formulario -->
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action="/login" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="password" id="password" placeholder="Tu contraseña" name="password" class="block w-full rounded-md border border-gray-200 bg-white dark:bg-neutral-700 dark:border-neutral-800 px-3 py-1.5 text-base text-gray-900 dark:text-neutral-200 placeholder:text-gray-400 dark:placeholder:text-neutral-400 focus:outline-none focus-within:ring-2 focus-within:ring-indigo-400 dark:focus-within:ring-indigo-500">
                        </div>
                    </div>
                    <!-- Campos -->
                    <div>
                        <button type="submit" class="flex w-full justify-center rounded-md bg-zinc-900 dark:bg-indigo-700 dark:hover:bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-zinc-700">Iniciar sesión</button>
                    </div>
                </form>    
